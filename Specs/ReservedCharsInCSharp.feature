...
Scenario: Using reserved C# characters in column names
    When I create a dynamic instance from this table
        ...
        | A value | 
    Then the CharpNmeWithStrangeChars property should be of type string and equal A value
...
Scenario: Only alfa numeric characters, plus underscore is allowed in variable names
    ...
    Then the My_Nice_Variable property should be of type string and equal A value
           And the MyVariableNeedsCleanUp property should be of type string and equal Another value
