...
namespace Specs
{
    ...
    [NUnit.Framework.DescriptionAttribute("Create dynamic sets objects from SpecFlow table using value converters")]
    public partial class CreateDynamicSetsObjectsFromSpecFlowTableUsingValueConvertersFeature
    {
...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Create dynamic sets objects from SpecFlow table using value converters", "In order to write only code that matters\r\nAs a SpecFlow developer\r\nI want SpecFlo" +
