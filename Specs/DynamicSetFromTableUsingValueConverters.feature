...
Scenario: Create set of dynamic objects using ValueToString converter
	When I create a set of dynamic instances using only ValueToString converter from this table 
...
Scenario: Create set of dynamic objects using ValueToDouble converter
	When I create a set of dynamic instances using only ValueToDouble converter from this table 
		| Name   | Age | Birth date | Length in meters |
		| Marcus | 39  | 1972-10-09 | 1.96             |
		| Albert | 3   | 2008-01-24 | 1.03             |
		| Gustav | 1   | 2010-03-19 | 0.84             |
...
Scenario: Create set of dynamic objects using ValueToDecimal converter
	When I create a set of dynamic instances using only ValueToDecimal converter from this table 
		| Name   | Age | Birth date | Length in meters |
		| Marcus | 39  | 1972-10-09 | 1.96             |
		| Albert | 3   | 2008-01-24 | 1.03             |
		| Gustav | 1   | 2010-03-19 | 0.84             |
...
Scenario: Create set of dynamic objects using ValueToInt converter
	When I create a set of dynamic instances using only ValueToInt converter from this table 
		| Name   | Age | Birth date | Length in meters |
		| Marcus | 39  | 1972-10-09 | 1.96             |
		| Albert | 3   | 2008-01-24 | 1.03             |
		| Gustav | 1   | 2010-03-19 | 0.84             |
...
Scenario: Create set of dynamic objects using ValueToDateTime converter
	When I create a set of dynamic instances using only ValueToDateTime converter from this table 
		| Name   | Age | Birth date | Length in meters |
		| Marcus | 39  | 1972-10-09 | 1.96             |
		| Albert | 3   | 2008-01-24 | 1.03             |
		| Gustav | 1   | 2010-03-19 | 0.84             |
...
Scenario: Create set of dynamic objects using ValueToDecimal and ValueToString converters
	When I create a set of dynamic instances using converters ValueToDecimal, ValueToString from this table 
		| Name   | Age | Birth date | Length in meters |
		| Marcus | 39  | 1972-10-09 | 1.96             |
		| Albert | 3   | 2008-01-24 | 1.03             |
		| Gustav | 1   | 2010-03-19 | 0.84             |
